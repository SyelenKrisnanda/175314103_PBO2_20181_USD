...
public class pasien { 
    ...
    private String noRekamMedis, nama, alamat, tempat_lahir;// membuat variable bertipe data Sting dan bersifat private
    ...
    public void setNoRekamMedis(String noRekamMedis) throws Exception {
        //membuat method void bernama setNoRekamMedis dengan parameter variabel noRekamMedis bertipe data integer dengan menambahkan throws Exception
